    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white rounded-3xl p-8 max-w-lg w-full shadow-2xl relative animate-in zoom-in-95 border-2 border-[#C5A059]">
           ...
           <div className="flex items-start gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-yellow-800 leading-relaxed">
                  To upgrade your account to the Pro or Pro Advance tier, please contact our Bhulia Hub Support Team. Our executives will assist you with the subscription process and instantly unlock your dashboard.
                </p>
              </div>
           </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-4 text-center border border-gray-100 mb-6">
           ...
           <p className="text-2xl font-black text-[#0066CC] mb-4">+91 7683811120</p>
           
           <a 
             href="https://wa.me/917683811120?text=Hi%20Bhulia%20Hub,%20I%20want%20to%20upgrade%20my%20account%20to%20the%20Pro%20Plan." 
             target="_blank" 
             rel="noopener noreferrer"
             className="w-full flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-md"
           >
