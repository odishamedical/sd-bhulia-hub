...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#051815] text-white selection:bg-[#C5A059] selection:text-black py-20 px-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 animate-in slide-in-from-bottom-8 duration-700">
          <Link href="/" className="inline-block text-[#C5A059] font-serif font-black text-xl mb-8 hover:text-white transition-colors">
            ← Back to Bhulia
          </Link>
          <h1 className="text-5xl md:text-7xl font-black font-serif text-white mb-6 tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto animate-in slide-in-from-bottom-12 duration-700 delay-300">
          ...
          <div className="bg-[#0A221E]/60 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 flex flex-col hover:border-slate-500 transition-colors">
            ...
            <Link href="/register-weaver" className="w-full block text-center py-4 rounded-xl border border-slate-600 text-slate-300 font-bold hover:bg-slate-800 transition-colors">
