        ...
        <div className="flex justify-between items-center gap-2 w-full">
          <div className="flex items-center gap-2 sm:gap-4 shrink-0 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="hidden sm:block text-[11px] text-gray-300 font-medium tracking-wide mt-1 truncate">
                Curated Storefront: {franchise.name}
              </p>
            </div>
          </div>

          <nav className="hidden lg:flex items-center gap-8 text-xs font-bold uppercase tracking-widest text-gray-200">
            <Link href="/" className="hover:text-[#C5A059] transition-colors">Marketplace Home</Link>
            {isOwner && (
              <Link href="/franchise/dashboard" className="bg-[#0A3A35] border border-[#C5A059]/50 text-[#C5A059] px-4 py-1.5 rounded-lg hover:bg-[#C5A059] hover:text-[#051815] transition-all font-bold">
                Go to Dashboard
              </Link>
            )}
          </nav>
          ...
          <div className="flex items-center gap-2 sm:gap-4 shrink-0">
            {userAvatar ? (
              ...
              <a href="https://sd-auth-center.vercel.app" className="bg-gradient-to-r from-[#996515] via-[#C5A059] to-[#996515] text-[#0A1021] px-5 py-2 rounded-xl font-bold text-xs uppercase tracking-wider shadow">
      ...
      <footer className="w-full bg-[#051815] border-t border-[#C5A059]/40 text-white py-8 px-6 mt-auto">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            ...
            <p className="text-[10px] text-gray-400 uppercase tracking-widest">Sovereign Franchise Network</p>
          </div>
