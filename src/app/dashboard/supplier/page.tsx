...
export default function SupplierDashboardPage() {
        ...
        try {
          ...
          if (userDoc.exists()) {
            ...
            if (actualRole !== "supplier") {
              // Redirect non-suppliers back to main dashboard
  ...
  const navItems: NavItem[] = [
    ...
    { id: "profile", label: "Supplier Profile", icon: "🏢", category: "User Management" },
  ];
      ...
      <div className="p-6">
        ...
        {activeTab === "home" && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 border-l-4 border-l-emerald-500">
              <h3 className="text-gray-500 font-bold mb-1">Active Weaver Clients</h3>
              <p className="text-4xl font-black text-emerald-900">0</p>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 border-l-4 border-l-amber-500">
              ...
              <p className="text-4xl font-black text-amber-900">0</p>
            </div>
          </div>
        )}
        ...
        {activeTab === "pricing" && (
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center py-20">
            ...
            <p className="text-gray-500 mb-6">Update your prices per Kg/Bundle. These will instantly reflect on your public storefront.</p>
