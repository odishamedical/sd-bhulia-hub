    ...
    <div className="space-y-6">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-2 font-medium">Broadcast mobile and desktop push notifications via Firebase Cloud Messaging.</p>
        </div>
      </header>
        ...
        <div className="flex-1 bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <select value={target} onChange={e => setTarget(e.target.value)} className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 text-sm font-medium focus:border-blue-500 outline-none">
            ...
            <div>
              ...
              <input type="text" value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g. Flash Sale Live Now! 🚀" className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 text-sm font-medium focus:border-blue-500 outline-none" />
            </div>
            <div>
              <label className="text-xs font-bold text-gray-500 mb-1.5 block">Notification Body</label>
              <textarea value={body} onChange={e => setBody(e.target.value)} rows={4} placeholder="e.g. Get 20% off all authentic Sambalpuri Silk sarees for the next 24 hours." className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 text-sm font-medium focus:border-blue-500 outline-none resize-none" />
            </div>
          ...
          <div className="bg-gray-100 rounded-3xl p-6 border-4 border-gray-300 h-full max-h-[500px] flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="w-full bg-white/80 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-gray-200 mt-10 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Shyam Dash Hub</span>
              </div>
